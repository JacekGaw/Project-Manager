...
const ProjectView = ({projectInfo, deleteProject, addNewTask, onAddTodo, onDeleteTodo} ) => {
    ...
    return (
        <section class="flex flex-col flex-1 w-full p-20">
            ...
            <Tasks taskList={onAddTodo} projectId={projectInfo.id} deleteTodo={onDeleteTodo} />
        </section>
    );
}
